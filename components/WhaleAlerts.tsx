              ...
              <tr key={tx.id} className="hover:bg-slate-700/50 transition-colors group">
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center border ${tx.type === 'Inflow' ? 'bg-red-500/10 border-red-500/20 text-red-400' :
                    ...
                    <div className="flex flex-col">
                      <span className={`text-sm font-bold ${tx.type === 'Inflow' ? 'text-red-400' :
